...
export async function gerarOrcamentoDOCX(orc: OrcamentoData, escritorio?: Escritorio | null): Promise<Blob> {
  ...
  const blocoLegal: Paragraph[] = anyRural
    ? [
        P({ text: "GEORREFERENCIAMENTO", bold: true, size: 22, keepNext: true, keepLines: true }),
        P({
        ...
        P({
          text: "Todos os imóveis rurais possuem a obrigatoriedade em fazer o georreferenciamento até 20 de novembro de 2025, prazo esse definido no Decreto 4.449/02, alterado pelo decreto 9.311/18.",
          spacing: 160,
          align: AlignmentType.JUSTIFIED,
          keepNext: true,
          keepLines: true,
        }),
        P({ text: "• Vigente para imóveis acima de 100 hectares;", spacing: 60, keepNext: true, keepLines: true }),
        P({ text: "• 20/11/2023 para os imóveis com área superior a 25 hectares;", spacing: 60, keepNext: true, keepLines: true }),
        P({ text: "• 20/11/2025 para os imóveis com área inferior a 25 hectares.", spacing: 120, keepLines: true }),
      ]
    : [];
